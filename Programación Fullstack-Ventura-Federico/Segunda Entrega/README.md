...
- [x] Modelo relacional normalizado en `MER_SGDM_Proyecto.graphml` (diagrama,
      con COMPETIDOR como supertipo de PARTICIPANTE/EQUIPO) y
      [`db/01-schema.sql`](../../SGDM%20App/db/01-schema.sql) (16 tablas)
- [x] DCL implementado en [`db/02-users.sh`](../../SGDM%20App/db/02-users.sh) (GRANT/REVOKE)
...
- [x] Implementación de los modelos alineados al modelo relacional en
...
- [x] Integración con PHP utilizando POO (mínimo gestión de usuarios
      funcionando) en [`app/api/register.php`](../../SGDM%20App/app/api/register.php)
...
- [x] Implementación con Apache en [`Dockerfile`](../../SGDM%20App/Dockerfile)
      y [`docker-compose.yml`](../../SGDM%20App/docker-compose.yml)
